...
function rssoku1() 
{   
    $feed = file_get_contents("https://www.cnnturk.com/feed/rss/turkiye/news");
...
$('.siyaset').load('bot/turkiye.php');
var refreshId = setInterval(function() {
$('.siyaset').load('bot/turkiye.php?randval='+ Math.random());
	 ...
	 <div style='float:right;' class='siyaset'> 
	 </div>
       </div>
          </body>
        </html>
